...
public class DespawnTweaker {
    ...
    static {
        ...
        structures = builder.comment("If you add sturctures registry names to list, only mobs in the structures will be affected by DespawnTweaker.", "However, this can be combined with StructuresMods").defineList("Structures", new ObjectArrayList<>(), o -> o instanceof String);
        builder.pop();
